...
import { ListaExxercicios1RoutingModule } from './lista-exxercicios1-routing-module';
...
@NgModule({
  ...
  imports: [CommonModule, ListaExxercicios1RoutingModule, FormsModule],
})
export class ListaExxercicios1Module {}
